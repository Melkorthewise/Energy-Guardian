...
<head>
    ...
    <meta http-equiv="refresh" content="5"> <!-- elke 5 seconden wordt de page geupdate-->
</head>
...
<body>
    ...
    <div class="bar_up">
        ...
        <span class="barUpTxtRight" onclick="main()">Main</span>
    ...
    <div id="barDown" class="bar_down">
        ...
        <div class="showTxtBarDown">
            <a onclick="change()" style="text-decoration:none; color:white">Change password</a><br>
            <a href="#" style="text-decoration:none; color:white" onclick="setDevice()">Connect device</a><br>
