...
# ! Use this command to translate db code to python: python manage.py inspectdb >website/models.py
...
class Device(models.Model):
    deviceid = models.IntegerField(db_column='DeviceID', primary_key=True)  # Field name made lowercase.
    name_device = models.CharField(db_column='Name_Device', max_length=255, blank=True, null=True)  # Field name made lowercase.
